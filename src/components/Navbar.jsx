  ...
  return (
    <header className={`bg-black text-white flex items-center justify-between p-4 lg:px-24 border-b-2 border-gray-500`}>
      ...
      {/* {user ? <div className="flex gap-4 text-gray-400">
        ...
        <NavLink className={({ isActive }) => `${isActive ? ' text-white font-bold' : ''}`} to='/dashboard/goals'>Goals</NavLink>
        <NavLink className={({ isActive }) => `${isActive ? ' text-white font-bold' : ''}`} to='/dashboard/profile'>Profile</NavLink>
      </div> : null} */}
